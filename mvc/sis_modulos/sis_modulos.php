...
<div class="form-group" align="right"><a href="sis_modulos.php" ><i class="fa fa-file-o"></i><? echo $nombre_b_insertar; ?></a> | <a href="sis_modulos_buscar.php" ><i class="fa fa-search"></i><? echo $nombre_boton_buscar; ?></a></div>  <div class="form-group">
   <label><? echo $campo['modulo']; ?></label><input class="form-control" id="modulo" name="modulo" type="text" size="100" maxlength="100" value="<? echo $_POST['modulo']?>" />
  </div>
