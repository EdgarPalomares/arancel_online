...
<div class="form-group" align="right"><a href="#"  onClick="xajax_ctrl.c_actualizar(<? echo $_POST['id']; ?>)" ><i class="fa fa-edit"></i><? echo $nombre_b_actualizar; ?></a> | <a href="sis_tablas.php" ><i class="fa fa-file-o"></i><? echo $nombre_b_insertar; ?></a> | <a href="sis_tablas_buscar.php" ><i class="fa fa-search"></i><? echo $nombre_boton_buscar; ?></a></div>
<table>     <div class="form-group"><label><? echo $campo['tabla'];?></label><p class="form-control-static"><? echo $_POST['tabla'];?></p></div>
     <div class="form-group"><label><? echo $campo['descripcion'];?></label><p class="form-control-static"><? echo $_POST['descripcion'];?></p></div>
     <div class="form-group"><label><? echo $campo['main_titulo'];?></label><p class="form-control-static"><? echo $_POST['main_titulo'];?></p></div>
