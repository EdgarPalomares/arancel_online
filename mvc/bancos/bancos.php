...
<div class="form-group" align="right"><a href="bancos.php" ><i class="fa fa-file-o"></i><? echo $nombre_b_insertar; ?></a> | <a href="bancos_buscar.php" ><i class="fa fa-search"></i><? echo $nombre_boton_buscar; ?></a></div>  <div class="form-group">
   <label><? echo $campo['banco']; ?></label><input class="form-control" id="banco" name="banco" type="text" size="45" maxlength="45" value="<? echo $_POST['banco']?>" />
  </div>
