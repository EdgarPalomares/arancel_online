<?
   /**********configuraciones*************/
     $titulo='B&uacute;squeda de tipo_solicitud';
...
<form id="form" name="form" method="post" action="tipo_solicitud.php" role="form" >
 
 <div class="form-group" align="right">

  <a href="tipo_solicitud.php" ><i class="fa fa-file-o"></i>Nuevo</a>

</div><table border="0"> 
  <tr>
  
   <td><? echo $campo['solicitud']; ?></td>
  </tr>
  <tr>
