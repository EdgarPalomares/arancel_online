<?
   /**********configuraciones*************/
     $titulo='B&uacute;squeda de solicitud_arancel';
...
<form id="form" name="form" method="post" action="solicitud_arancel.php" role="form" >
 ...
 <div class="form-group" align="right">
  ...
  <a href="solicitud_arancel.php" ><i class="fa fa-file-o"></i>Nuevo</a>

</div><table border="0"> 
  <tr>
  
   <td><? echo $campo['nro_solicitud']; ?></td>
  
   <td><? echo $campo['fecha']; ?></td>
  </tr>
  <tr>
   ...
   <td ><input id="fecha" class="form-control" name="fecha" type="text" size="20" maxlength="10" value="<? echo $_POST['fecha']?>" /></td>
