...
<div class="form-group" align="right"><a href="#"  onClick="xajax_ctrl.c_actualizar(<? echo $_POST['id']; ?>)" ><i class="fa fa-edit"></i><? echo $nombre_b_actualizar; ?></a> | <a href="unidad_tributaria.php" ><i class="fa fa-file-o"></i><? echo $nombre_b_insertar; ?></a> | <a href="unidad_tributaria_buscar.php" ><i class="fa fa-search"></i><? echo $nombre_boton_buscar; ?></a></div>
<table>     <div class="form-group"><label><? echo $campo['unidad'];?></label><p class="form-control-static"><? echo $_POST['unidad'];?></p></div>
     <div class="form-group"><label><? echo $campo['fecha'];?></label><p class="form-control-static"><? echo $_POST['fecha'];?></p></div>
     <div class="form-group"><label><? echo $campo['is_inactiva'];?></label><p class="form-control-static"><? echo $_POST['is_inactiva'];?></p></div>
