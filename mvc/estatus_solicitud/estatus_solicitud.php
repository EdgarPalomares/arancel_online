...
<div class="form-group" align="right"><a href="estatus_solicitud.php" ><i class="fa fa-file-o"></i><? echo $nombre_b_insertar; ?></a> | <a href="estatus_solicitud_buscar.php" ><i class="fa fa-search"></i><? echo $nombre_boton_buscar; ?></a></div>  <div class="form-group">
   <label><? echo $campo['estatus']; ?></label><input class="form-control" id="estatus" name="estatus" type="text" size="100" maxlength="100" value="<? echo $_POST['estatus']?>" />
  </div>
