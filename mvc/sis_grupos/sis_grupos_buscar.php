<?
   /**********configuraciones*************/
     $titulo='B&uacute;squeda de Grupos';
...
<form id="form" name="form" method="post" action="sis_grupos.php" role="form" >
 
 <div class="form-group" align="right">

  <a href="sis_grupos.php" ><i class="fa fa-file-o"></i>Nuevo</a>
