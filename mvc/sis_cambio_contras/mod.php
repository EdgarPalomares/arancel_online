...
class mod extends Conexion{
     ...
     function busqueda()
     {
          $result=$this->EjecutarSql("select * from sis_usuarios  where  password='".sha1($this->getanterior())."' and id=".$_SESSION['id_usuario'].";");
     return $result;
     }
	 
	 function insertar()
     {
          $result=$this->EjecutarSql("update sis_usuarios  set  password='".sha1($this->getconfirmar())."' where id=".$_SESSION['id_usuario'].";");
     return $result;
     }
