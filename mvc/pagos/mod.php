...
class mod extends Conexion{
     ...
     function insertar()
     {
          ...
          {
               $this->Ejecutar("insert into pagos(id_solicitud_arancel,id_bancos,monto,nro_deposito) values(".$this->getid_solicitud_arancel().",".$this->getid_bancos().",'".$this->getmonto()."','".$this->getnro_deposito()."');");
               $boolean=1;
          }
          return $boolean;
         }
