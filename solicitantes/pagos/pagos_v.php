...
<form id="form" role="form" name="form" method="post" >
 ...
 <div class="col-md-8"><div class="box box-primary"><div class="panel-heading"><h4><i class="fa fa-credit-card"></i><? echo $titulo; ?></h4></div><div class="panel-body"><div class="row"><div class="col-lg-12"><input type="hidden" id="id"  name="id" value="<? echo $_POST["id"]; ?>" />
<div class="form-group" align="right"><a href="#"  onClick="xajax_ctrl.c_actualizar(<? echo $_POST['id']; ?>)" ><i class="fa fa-edit"></i><? echo $nombre_b_actualizar; ?></a> | <a href="pagos.php" ><i class="fa fa-file-o"></i><? echo $nombre_b_insertar; ?></a> | <a href="pagos_buscar.php" ><i class="fa fa-search"></i><? echo $nombre_boton_buscar; ?></a></div>
<table>     <div class="form-group"><label><? echo $campo['nro_solicitud'];?></label><p class="form-control-static"><? echo $_POST['nro_solicitud'];?></p></div>
     ...
     <div class="form-group"><label><? echo $campo['banco'];?></label><p class="form-control-static"><? echo $_POST['banco'];?></p></div>
     <div class="form-group"><label><? echo $campo['monto'];?></label><p class="form-control-static"><? echo $_POST['monto'];?></p></div>
     <div class="form-group"><label><? echo $campo['nro_deposito'];?></label><p class="form-control-static"><? echo $_POST['nro_deposito'];?></p></div>
