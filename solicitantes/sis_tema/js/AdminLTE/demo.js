$(function() {
    ...
    demo_settings.append(
            "<h3 style='margin: 0 0 5px 0; border-bottom: 1px dashed #ddd; padding-bottom: 3px;'>Layout Options</h3>"
    ...
    demo_settings.append(
            "<h3 style='margin: 0 0 5px 0; border-bottom: 1px dashed #ddd; padding-bottom: 3px;'>Skins</h3>"
            + "<div class='form-group no-margin'>"
            + "<div class='.radio'>"
            + "<label>"
